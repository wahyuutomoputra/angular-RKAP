...
import { Rkap, KategoriAktif, IndikatorInput, Rab } from './persetujuan.model';
...
export class PersetujuanService {
  ...
  getRole(): Observable<any> {
    ...
    return this.http.get(this.resourceUrlRole + '/query?username='+username)
  }
  ...
  getAll(role): Observable<any> {

    const username = localStorage.getItem('username');
    const token = localStorage.getItem('token');
    var url = this.resourceUrlRole + '/table';

    var tglAtasan = "";
    var tglUser = "";
    if(role=="Renko"){
      tglAtasan = "tgl_approve_gm";
      tglUser = "tgl_review_renko";
    }else if(role="Risk"){
      tglAtasan = "tgl_review_renko";
      tglUser = "tgl_review_risk";
    }else if(role=="Finance"){
      tglAtasan = "tgl_review_risk";
      tglUser = "tgl_approve_finance";
    }else if(role=="SPKK"){
      tglAtasan = "tgl_approve_finance";
      tglUser = "tgl_approve_spkk";
    }else if(role=="Dir"){
      tglAtasan = "tgl_approve_spkk";
      tglUser = "tgl_approve_dir";
    }
    ...
    //    })
    // }else{
    //   return this.http.post < any > (this.resourceUrlRole+'/getRKAP?tglAtasan='+tglAtasan+'&tglUser='+tglUser, {
    //     username : username,
    //     token : token
    //   })
    // }
    if(role!="GM"){
      url = this.resourceUrlRole+'/getRKAP?tglAtasan='+tglAtasan+'&tglUser='+tglUser;
    }
    console.log(url);
  ...
  getLimit(offset,limit, role): Observable<any> {
